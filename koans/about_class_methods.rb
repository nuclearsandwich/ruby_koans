...
class AboutClassMethods < EdgeCase::Koan
  ...
  # ANSWER: For regular methods I tend toward the clearer `self.method` syntax.
  # However, whenever I do fancy stuff like class level attrs or other common
  # metaprogramming constructs I use the eigenclass syntax. I also use it if I
  # have a crapton of class methods to write.
