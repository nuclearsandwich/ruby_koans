...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  #
  # Why?
  # Me: They match as much of the string as they can.
  ...
  # ANSWER: Character classes match any of the given letters whereas alternation
  # tests whole clauses as well as allows for backreferencing.
