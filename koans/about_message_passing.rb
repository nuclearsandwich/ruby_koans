...
class AboutMessagePassing < EdgeCase::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # ANSWER: So you can overload the send method for a domain specific method.
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    #
    # ANSWER: We can use method missing for cool things like dynamic methods
    # but if you don't defer to super when you aren't going to do anything you
    # could cause delightfully scary behavior.
    #
    # NOTE:
    #
